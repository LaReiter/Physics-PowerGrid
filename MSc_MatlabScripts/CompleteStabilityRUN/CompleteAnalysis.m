...
% try
%    [A,B] = DynamicTestFunc_SmartStep(1, 'C', t,KC);
...
% 
% try
%    [A2,B2] = DynamicTestFunc_SmartStep(1, 'U', t,KC);
...
% 
% try
%    [A,B] = DynamicTestFunc_SmartStep(1, 'R', t,KC);
...
% 
% try
%    [A,B] = DynamicTestFunc_SmartStep(2, 'C', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(2, 'U', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(2, 'R', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(3, 'C', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(3, 'U', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(3, 'R', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(4, 'C', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(4, 'U', t,KC);
...
try
   [A,B] = DynamicTestFunc_SmartStep(4, 'R', t,KC);
